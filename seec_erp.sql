...
CREATE TABLE `sale_returns_sheet_content` (
	`id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
	 `sale_return_sheet_id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '进货退货单id',
	`pid` CHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '商品id',
	`quantity` INT(11) NULL DEFAULT NULL COMMENT '数量',
	`unit_price` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '单价',
	`total_price` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '金额',
...
CREATE TABLE `sale_returns_sheet` (
	`id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '销售退货单id',
	`supplier` INT(11) NULL DEFAULT NULL COMMENT '供应商',
	`operator` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作员',
	`remark` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
	`state` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '单据状态',
	...
	`voucher` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '抵用券',
	`discount` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '折扣',
	`sale_sheet_id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '销售单id',
	PRIMARY KEY (`id`) USING BTREE
) ENGINE = INNODB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

DROP TABLE IF EXISTS `account_sheet`;
CREATE TABLE `account_sheet` (
    `name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '账户名字',
    `deposit` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '余额',
    PRIMARY KEY (`name`) USING BTREE
) ENGINE = INNODB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

DROP TABLE IF EXISTS `receipt_sheet`;
CREATE TABLE `receipt_sheet` (
    `id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '单据id',
    `customer` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '客户',
    `operator` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作员',
    `total_amount` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '总价',
    `create_time` DATETIME(0) NOT NULL COMMENT '创建时间',
  `state` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '单据状态',
...
CREATE TABLE `receipt_sheet_content`(
    `id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '收款单号',
    `name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '名字',
    `transfer_amount` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '交易金额',
    `remark` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
    PRIMARY KEY (`name`) USING BTREE
)ENGINE = INNODB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pay_sheet`(
    `id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '单据id',
    `operator` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作员',
    `name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '支付人',
    `total_amount` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '总价',
    `create_time` DATETIME(0) NOT NULL COMMENT '创建时间',
    `state` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '单据状态',
     PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pay_sheet_content`(
    `id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '付款单号',
...
DROP TABLE IF EXISTS `sale_detail_sheet`;
CREATE TABLE `sale_detail_sheet`(
    `sheet_type` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '单据种类',
    `product_id` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品名',
    `type` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品种类',
    `quantity` INT(11) NULL DEFAULT NULL COMMENT '数量',
    `unit_price` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '单价',
...
CREATE TABLE `employee_sheet`(
    ...
    `name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工姓名',
    `gender`CHAR(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '性别',
    `birth_date` DATETIME(0) NOT NULL COMMENT '生日',
    `telenum` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '电话',
    `role` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '岗位',
    `level` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '岗位等级',
    `raw_salary` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '基础工资',
    `role_salary` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '岗位工资',
    `account` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工银行账户',
    PRIMARY KEY (`id`) USING BTREE
)ENGINE = INNODB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `salary_sheet`(
    ...
    `name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工姓名',
    `account` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工账户',
    `raw_salary` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '税前工资',
    `individual` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '个人所得税',
    `unemployment` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '失业保险',
    `housing` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '住房公积金',
    `tax` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '税款总额',
    `final_salary` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '住房公积金',
    `state` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '单据状态',
    `create_time` DATETIME(0) NOT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE
)ENGINE = INNODB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;


DROP TABLE IF EXISTS `clock_in_sheet`;
CREATE TABLE `clock_in_sheet`(
    `name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工姓名',
    `telenum` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '电话',
    `clockInTimes` INT(11) NULL DEFAULT NULL COMMENT '本月打卡次数',
    `lastDate` DATETIME(0) NOT NULL COMMENT '上次打卡的时间',
    PRIMARY KEY (`telenum`) USING BTREE
)ENGINE = INNODB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;


DROP TABLE IF EXISTS `initial_sheet`;
CREATE TABLE `initial_sheet`(
   `id` CHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分类id(11位) + 位置(5位) = 编号',
  `name` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '名字',
  `category_id` INT(11) NOT NULL COMMENT '商品分类id',
  `type` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品型号',
  ...
  `recent_pp` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '最近进价',
  `recent_rp` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '最近零售价',
  `customer_type` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分类(供应商\\销售商)',
  `level` INT(11) NULL DEFAULT NULL COMMENT '级别（五级，一级普通用户，五级VIP客户）',
  `customer_name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `phone` VARCHAR(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电话号码',
  `address` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '地址',
  `zipcode` CHAR(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮编',
  `email` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电子邮箱',
  ...
  `payable` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '应付（本公司欠客户的钱）',
  `operator` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '默认业务员',
   `account_name` VARCHAR(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '账户名字',
    `deposit` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '余额',
...
CREATE TABLE `sale_status`(
    ...
    `in` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '折让后收入',
    `discount` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '折让',
    `out` DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '总支出',
    `profit`DECIMAL(10, 2) NULL DEFAULT NULL COMMENT '总利润 ',
    PRIMARY KEY (`id`) USING BTREE
)ENGINE = INNODB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;